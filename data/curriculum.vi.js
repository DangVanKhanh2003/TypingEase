...
window.TypingEaseCurriculum = {
  ...
  lessons: {
    ...
    'u2-l01': { title: 'T và Y', newKeys: ['t', 'y'], screens: 11, estMinutes: 5, kind: 'keys', ready: false },
    'u2-l02': { title: 'O và W', newKeys: ['o', 'w'], screens: 11, estMinutes: 5, kind: 'keys', ready: false },
    'u2-l03': { title: 'C và N', newKeys: ['c', 'n'], screens: 12, estMinutes: 6, kind: 'keys', ready: false },
    'u2-l04': { title: 'M và V', newKeys: ['m', 'v'], screens: 11, estMinutes: 5, kind: 'keys', ready: false },
    'u2-l05': { title: 'Ôn tập 20 phím', newKeys: [], screens: 9, estMinutes: 5, kind: 'review', ready: false },
    'u2-l06': { title: 'Q và P', newKeys: ['q', 'p'], screens: 11, estMinutes: 5, kind: 'keys', ready: false },
    'u2-l07': { title: 'B và X', newKeys: ['b', 'x'], screens: 11, estMinutes: 5, kind: 'keys', ready: false },
    'u2-l08': { title: 'Z, dấu chấm và dấu phẩy', newKeys: ['z', '.', ','], screens: 11, estMinutes: 6, kind: 'keys', ready: false },
    'u2-l09': { title: 'Enter và Shift (viết hoa)', newKeys: ['shift', 'enter'], screens: 9, estMinutes: 5, kind: 'keys', ready: false },
    'u2-l10': { title: 'Luyện phím yếu', newKeys: [], screens: 1, estMinutes: 2, kind: 'weak', seconds: 120, ready: false },
    'u2-l11': { title: 'Kiểm tra Unit 2', newKeys: [], screens: 1, estMinutes: 1, kind: 'test', seconds: 60, ready: false },

    'u3-l01': { title: 'Dấu sắc và dấu huyền', newKeys: ['s', 'f'], screens: 10, estMinutes: 5, kind: 'keys', inputMode: 'telex', ready: false },
    'u3-l02': { title: 'Dấu hỏi, ngã, nặng', newKeys: ['r', 'x', 'j'], screens: 10, estMinutes: 5, kind: 'keys', inputMode: 'telex', ready: false },
    'u3-l03': { title: 'Â Ê Ô và Đ', newKeys: ['aa', 'ee', 'oo', 'dd'], screens: 10, estMinutes: 5, kind: 'keys', inputMode: 'telex', ready: false },
    'u3-l04': { title: 'Ă Ư Ơ', newKeys: ['aw', 'uw', 'ow'], screens: 10, estMinutes: 5, kind: 'keys', inputMode: 'telex', ready: false },
    'u3-l05': { title: 'Từ thông dụng tiếng Việt', newKeys: [], screens: 9, estMinutes: 5, kind: 'review', inputMode: 'telex', ready: false },
    'u3-l06': { title: 'Câu ngắn', newKeys: [], screens: 8, estMinutes: 5, kind: 'review', inputMode: 'telex', ready: false },
    'u3-l07': { title: 'Luyện phím yếu', newKeys: [], screens: 1, estMinutes: 2, kind: 'weak', seconds: 120, inputMode: 'telex', ready: false },
    'u3-l08': { title: 'Kiểm tra Unit 3', newKeys: [], screens: 1, estMinutes: 1, kind: 'test', seconds: 60, inputMode: 'telex', ready: false },

    'u4-l01': { title: 'Số 1-5 và 6-0', newKeys: ['1', '2', '3', '4', '5', '6', '7', '8', '9', '0'], screens: 12, estMinutes: 6, kind: 'keys', ready: false },
    'u4-l02': { title: 'Ký hiệu thường gặp', newKeys: ['@', '#', '/', '-', '_', ':', '?', '!'], screens: 10, estMinutes: 5, kind: 'keys', ready: false },
    'u4-l03': { title: 'Email, web và mật khẩu', newKeys: [], screens: 8, estMinutes: 5, kind: 'review', ready: false },
    'u4-l04': { title: 'Đoạn văn và tốc độ 1', newKeys: [], screens: 7, estMinutes: 5, kind: 'review', inputMode: 'telex', ready: false },
    'u4-l05': { title: 'Đoạn văn và tốc độ 2', newKeys: [], screens: 7, estMinutes: 6, kind: 'review', inputMode: 'telex', ready: false },
    'u4-l06': { title: 'Tổng kết và Kiểm tra cuối', newKeys: [], screens: 1, estMinutes: 3, kind: 'test', seconds: 180, inputMode: 'telex', ready: false }
  },
